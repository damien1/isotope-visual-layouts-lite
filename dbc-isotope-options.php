...
<div class="inner-sidebar">
	...
	<a href="https://twitter.com/share" class="twitter-share-button" data-url="http://wordpress.damien.co/isotope" data-counturl="http://wordpress.damien.co/isotope" data-count="horizontal" data-via="damiensaunders">Tweet</a><script type="text/javascript" src="//platform.twitter.com/widgets.js"></script>	
		...
		<ul>
		<li> Want to <a target="_blank" href="http://whitetshirtdigital.com/shop/isotope-visual-layouts-wordpress-plugin-pro/?utm_source=WordPress&utm_medium=dbc-isotope-lite-installed&utm_campaign=Isotope-Lite">change my CSS or HTML then please help and Purchase a Pro Plugin</a>.</li>
		</ul>
		</div> <!-- .inside -->
		</div>
